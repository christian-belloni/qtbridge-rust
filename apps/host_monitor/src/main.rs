...
impl Backend {
    ...
    qproperty!("latency", Member = latency, Write = set_latency, Notify = "latencyChanged");
    qproperty!("status", Member = status, Write = set_status, Notify = "statusChanged");
    qproperty!("hostname", Member = hostname, Write = set_hostname, Notify = "hostnameChanged");
    ...
    fn make_request(&self) {
        ...
        self.runtime.spawn(async move {
            ...
            // accordingly.
            invoke_method!(invoker, "updateStatus", result, latency);
        });
    }

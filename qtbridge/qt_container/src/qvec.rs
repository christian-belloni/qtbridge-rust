...
mod qvec
{
    ...
    where
        T: crate::QModelItem + fmt::Debug + Default + 'static
    {
    ...
    impl<T: Default + crate::QModelItem, I: SliceIndex<[T]>> std::ops::Index<I> for QVec<T> {
    ...
    impl<T: Default + crate::QModelItem> QVec<T> {

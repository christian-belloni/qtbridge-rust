...
use qt_gen_common_no_types::format_code::{format_rust_code, try_format_cpp_code};
use qt_gen_common_no_types::naming;
use qt_gen_common_no_types::path_utils::relative_input_file_path_to_path_qualified;
...
const DEST_CRATE_ROOT: &str = "../../../qt_type_lib";
const TYPE_INFO_DIR: &str = "../../../qt_gen/impl/qt_gen_common/src/";
...
fn main() {
    ...
    let qt_type_info_dir = PathBuf::from(TYPE_INFO_DIR);
    create_dirs(&qt_type_info_dir)
        .unwrap();
    TypeGenerator::store_qt_type_init_code(&qt_type_info_dir.join("qt_types.rs"))
        .unwrap();
}

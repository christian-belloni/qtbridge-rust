...
use super::interface_trait::QAbstractListModel;
...
pub struct QAbstractListModelProxyRust {
    ...
    #[allow(dead_code)]
    rust_obj: RustObjAccess<dyn QAbstractListModel>,
    on_drop: fn(rust_obj: *const u8),
}
impl QAbstractListModelProxyRust {
    pub fn new(rust_obj: &Rc<RefCell<dyn QAbstractListModel>>, register_strong: bool, on_drop: fn(rust_obj: *const u8)) -> *mut Self {
    ...
    pub fn new_with_cpp_proxy_at(addr: *mut u8, rust_obj: &Rc<RefCell<dyn QAbstractListModel>>, on_drop: fn(rust_obj: *const u8)) -> *mut Self {
        let raw_rust_obj = rust_obj.as_ptr();
        let boxed_self = Box::new(Self {
            cpp_proxy: std::ptr::null_mut(),

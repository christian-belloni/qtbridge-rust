...
impl QAbstractItemModelProxyRust {
    pub fn new(rust_obj: &Rc<RefCell<dyn QAbstractItemModelProxyGet>>, register_strong: bool, on_drop: fn(rust_obj: *const u8)) -> *mut Self {
    ...
    pub fn new_with_cpp_proxy_at(addr: *mut u8, rust_obj: &Rc<RefCell<dyn QAbstractItemModelProxyGet>>, on_drop: fn(rust_obj: *const u8)) -> *mut Self {
        let raw_rust_obj = rust_obj.as_ptr();
        let boxed_self = Box::new(Self {
            cpp_proxy: std::ptr::null_mut(),
    ...
    pub fn parent(&self, child: &QModelIndex) -> QModelIndex {
        self.rust_obj
            .try_with_borrow(|vtable| vtable.get_trait().parent(child))
    ...
    pub fn column_count(&self, parent: &QModelIndex) -> i32 {
        self.rust_obj
            .try_with_borrow(|vtable| vtable.get_trait().column_count(parent))

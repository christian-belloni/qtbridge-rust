...
pub mod ffi {
    unsafe extern "C++" {
        ...
        include!("qt_ifaces/src/manual/qtable_model/proxy_rust_bridge.rs.h");
        type QTableModelProxyRust = super::QTableModelProxyRust;
    }
    #[namespace = "rust::bridge"]
    unsafe extern "C++" {
        include!("qt_ifaces/src/manual/qtable_model/cpp/QTableModelProxyCpp.h");
        type QTableModelProxyCpp;
        # [rust_name = create_qtable_model_proxy_cpp]
        unsafe fn create_QTableModelProxyCpp(rust_obj: *mut u8, rust_proxy: *mut QTableModelProxyRust) -> *mut QTableModelProxyCpp;
        # [rust_name = create_qtable_model_proxy_cpp_at]
        unsafe fn create_QTableModelProxyCpp_At(addr: *mut u8, rust_obj: *mut u8, rust_proxy: *mut QTableModelProxyRust)

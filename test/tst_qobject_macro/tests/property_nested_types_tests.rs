...
pub mod node {
    ...
    impl Node {
        qproperty!("value", Member = value, Write = set_value, Notify = "valueChanged");
        qproperty!("left", Read = get_left, Write = set_left, Notify = "leftChanged");
        qproperty!("right", Read = get_right, Write = set_right, Notify = "rightChanged");

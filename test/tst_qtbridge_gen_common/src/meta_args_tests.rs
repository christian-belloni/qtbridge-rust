...
pub fn tst_qmetatype_support_for_strings()
{
    ...
    let inputs = [
        ("str",    Some("qtbridge_type_lib::QString")),
        ("String", Some("qtbridge_type_lib::QString")),
    ];
...
pub fn tst_qmetatype_support_for_vectors() {
    qtbridge_type_lib::init();
    let inputs = [
        ("Vec<i8>",      Some("qtbridge_type_lib::QList_i8")),
        ("Vec<u8>",      Some("qtbridge_type_lib::QList_u8")),
        ("Vec<i16>",     Some("qtbridge_type_lib::QList_i16")),
        ("Vec<u16>",     Some("qtbridge_type_lib::QList_u16")),
        ("Vec<i32>",     Some("qtbridge_type_lib::QList_i32")),
        ("Vec<u32>",     Some("qtbridge_type_lib::QList_u32")),
        ("Vec<i64>",     Some("qtbridge_type_lib::QList_i64")),
        ("Vec<u64>",     Some("qtbridge_type_lib::QList_u64")),
        ("Vec<f32>",     Some("qtbridge_type_lib::QList_f32")),
        ("Vec<f64>",     Some("qtbridge_type_lib::QList_f64")),
        ("Vec<String>",  Some("qtbridge_type_lib::QList_QString")),
    ];

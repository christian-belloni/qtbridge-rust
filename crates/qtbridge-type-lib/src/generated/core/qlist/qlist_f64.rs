...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        # [rust_name = inline_cpp_fn_trait_impl_partial_eq_for_qlist_f64_eq]
        fn inlineCppFn_TraitImpl_PartialEq_for_QList_f64_eq(lhs: &QList_f64, rhs: &QList_f64) -> bool;
...
impl crate::QMetaTypeGet for QList_f64 {
...
impl PartialEq for QList<f64> {
    fn eq(&self, other: &Self) -> bool {
        let cpp = ffi::inline_cpp_fn_trait_impl_partial_eq_for_qlist_f64_eq;
        cpp(self, other)
    }
}

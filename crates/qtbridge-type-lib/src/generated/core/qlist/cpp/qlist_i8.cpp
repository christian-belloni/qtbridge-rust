...
{
        return QMetaType::fromType<QList_i8>();
}
...
{
rust::Vec<int8_t>result;result.reserve(static_cast<size_t>(src.size()));for(int8_t item:src)result.push_back(item);return result;
}

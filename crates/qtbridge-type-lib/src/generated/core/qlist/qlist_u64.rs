...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        # [rust_name = inline_cpp_fn_trait_impl_partial_eq_for_qlist_u64_eq]
        fn inlineCppFn_TraitImpl_PartialEq_for_QList_u64_eq(lhs: &QList_u64, rhs: &QList_u64) -> bool;
...
impl crate::QMetaTypeGet for QList_u64 {
...
impl PartialEq for QList<u64> {
    fn eq(&self, other: &Self) -> bool {
        let cpp = ffi::inline_cpp_fn_trait_impl_partial_eq_for_qlist_u64_eq;
        cpp(self, other)
    }
}

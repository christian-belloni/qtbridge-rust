...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        # [rust_name = inline_cpp_fn_trait_impl_partial_eq_for_qlist_u32_eq]
        fn inlineCppFn_TraitImpl_PartialEq_for_QList_u32_eq(lhs: &QList_u32, rhs: &QList_u32) -> bool;
...
impl crate::QMetaTypeGet for QList_u32 {
...
impl PartialEq for QList<u32> {
    fn eq(&self, other: &Self) -> bool {
        let cpp = ffi::inline_cpp_fn_trait_impl_partial_eq_for_qlist_u32_eq;
        cpp(self, other)
    }
}

...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        # [rust_name = inline_cpp_fn_trait_impl_partial_eq_for_qlist_bool_eq]
        fn inlineCppFn_TraitImpl_PartialEq_for_QList_bool_eq(lhs: &QList_bool, rhs: &QList_bool) -> bool;
...
impl crate::QMetaTypeGet for QList_bool {
...
impl PartialEq for QList<bool> {
    fn eq(&self, other: &Self) -> bool {
        let cpp = ffi::inline_cpp_fn_trait_impl_partial_eq_for_qlist_bool_eq;
        cpp(self, other)
    }
}
